...
const Impact = () => {
        ...
        <div className="home-imp-img">
          <div className="position-relative">
            ...
            <div className="home-imp-img2">
              <img
                src={link.full_path_hover_image}
                alt="logo"
              />
            </div>
          </div>
            ...
            <SwiperSlide key={index}>
              <div className="text-center">
                <img
                  ...
                  alt="logo"
                />
                <p className="bold-font text-uppercase text-green pt-3">{link.title}</p>
                <p className="regular-font pt-2 px-5">{link.description}</p>
              </div>
            </SwiperSlide>
        ))}
  ...
  return (
    <div className="container mt-5 pt-3 position-relative">
        <div className="vertical-txt-home text-center pb-lg-0 pb-4">
